...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        ...
        ImageIcon wallpaper = new ImageIcon("src/itp_library/images/wallpaperPrincipal.jpg");
        Icon icono = new ImageIcon(wallpaper.getImage().getScaledInstance(jLabel_Wallpaper.getWidth(),
                jLabel_Wallpaper.getHeight(), Image.SCALE_DEFAULT));
        jLabel_Wallpaper.setIcon(icono);
        this.repaint();
        
        ImageIcon wallapper_logo = new ImageIcon("src/itp_library/images/icono.png");
    ...
    private void initComponents() {
        ...
        getContentPane().add(txt_Password, new org.netbeans.lib.awtextra.AbsoluteConstraints(95, 379, 210, -1));
        ...
        jButton2.setText("Click para nuestro catalogo ");
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 290, 200, 30));
        ...
        if (!user.equals("") || !pass.equals("")) {
            ...
            try {
                ...
                PreparedStatement pst = conn.prepareStatement(
                        "select tipo_nivel, estatus from Trabajador where username = '" + user
                        + "' and password = '" + pass + "'");
                ...
                if (rs.next()) {
                    ...
                    } else if (tipo_nivel.equalsIgnoreCase("Bibliotecario") && estatus.equalsIgnoreCase("Activo")) {
                        dispose();
                        new Dashboard_bibliotecario().setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
              Book_Clients  Book_Clients  = new  Book_Clients ();
       Book_Clients .setVisible(true);
